...
//namespace SocialSiteV4.Infrastructure
//{
//    public class AuthorizeTheUserAttribute : AuthorizeAttribute
//    {
...
//            AspNetUser user2 = _dal.GetUserByUsername(user.Identity.Name);
//            routeData.Values["profile"] = profile;
//            if (profile.AspNetUser.Id.Equals(user2.Id))
//            {
//                return true;
//            }
