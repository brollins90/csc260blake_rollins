...
-- --------------------------------------------------
-- Date Created: 02/27/2015 10:37:09
-- Generated from EDMX file: C:\_\src\csc260blake_rollins\SocialSiteV4\SocialSiteV4\SocialDBModel.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [aspnet-SocialSiteV4-20150226082858];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_ProfileFavorites]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Favorites] DROP CONSTRAINT [FK_ProfileFavorites];
GO
...
-- Creating foreign key on [AspNetUser_Id] in table 'Profiles'
ALTER TABLE [dbo].[Profiles]
...
-- Creating foreign key on [ProfileId] in table 'Favorites'
ALTER TABLE [dbo].[Favorites]
ADD CONSTRAINT [FK_ProfileFavorites]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_ProfileFavorites'
CREATE INDEX [IX_FK_ProfileFavorites]
ON [dbo].[Favorites]
    ([ProfileId]);
GO
